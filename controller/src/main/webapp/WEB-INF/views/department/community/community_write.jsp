...
<jsp:include page="../../include/sidebar.jsp" flush="false"/>
		...
		<div id="mid">
			<div class="content_view">
				<div class="content_view_depth"><h3>학과관리 > 커뮤니티 작성</h3></div>
						
								<form action="/department/community/writeprocess" method="post" id="frm">
									...
									<tfoot align="center">  
									   <tr style="text-align:center;">
											<td colspan="4" class="table_paging" > 
												<input type="button"  id="savebutton" value="작성"><input type= "button" id="community_list_btn" value="목록">
											</td>
										</tr>     
									</tfoot>
								</table>
